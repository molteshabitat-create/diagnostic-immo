...
- Le diagnostic porte principalement sur les besoins de chauffage (hiver). Dans "score_transparence", en une phrase, adapte le message sur le confort d'été selon ce qui a été identifié : SI aucun système de climatisation/PAC réversible (splits visibles, PAC air-air) n'a été détecté sur les photos ni déclaré dans le chauffage, rappelle que le confort d'été (surchauffe estivale) n'est pas garanti par cette analyse — il dépend du type d'isolant (inertie), de l'orientation et de la surface vitrée, d'autant plus si de larges surfaces vitrées ou une véranda sont visibles. SI en revanche des PAC réversibles ou climatisations sont déjà identifiées sur le bien (splits visibles, chauffage déclaré incluant une PAC air-air), indique au contraire positivement que le confort d'été est couvert par ce système déjà en place, qui assure aussi bien le chauffage que le rafraîchissement — ne répète pas l'avertissement générique dans ce cas.
