...
PONDÉRATION SELON LA TAILLE DE L'ABRI DE JARDIN : si une surface est déclarée pour l'abri, module l'importance de cet argument en conséquence — un petit cabanon (moins de 6m²) reste un argument mineur, à ne mentionner que brièvement voire pas du tout s'il y a des points plus importants à couvrir. Un abri en dur de taille conséquente (10m²+) est un vrai argument de vente à part entière (rangement volumineux, atelier, extension de stockage), à mentionner explicitement comme un plus notable, potentiellement dans une question/réponse dédiée. Si aucune surface n'est déclarée, reste neutre sur l'ampleur de l'atout sans inventer une taille.
