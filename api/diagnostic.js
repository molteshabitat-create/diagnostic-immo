...
- Limites de longueur strictes à respecter : "enveloppe_thermique" et "chauffage_ventilation" : 50-75 mots maximum chacun. "points_vigilance" : 4 à 5 items maximum (pas 6), une phrase courte chacun (12-18 mots), pas de sous-clauses. "budget_detail" : 35-50 mots maximum. "arguments_negociation" : 3 à 4 items maximum, 15-20 mots chacun. "questions_reponses" : 3 à 4 paires maximum (pas 5), réponse de 25-35 mots maximum chacune. "score_transparence" : 40-60 mots maximum (inclut la phrase sur le confort d'été, positive ou négative selon le cas, voir règle dédiée). Sois dense et concret, élimine tout mot qui n'apporte pas d'information nouvelle — chaque champ doit tenir dans sa limite même quand plusieurs sujets complexes se cumulent sur un même bien (DPE, fioul, ECS, piscine, etc.) : priorise les points les plus importants plutôt que de tout citer en détail.
