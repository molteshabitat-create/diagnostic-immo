...
5) APRÈS AVOIR DÉTERMINÉ LE POINT D'ANCRAGE (prix/m² × surface), applique SYSTÉMATIQUEMENT cette checklist dans l'ordre, un point après l'autre — ne saute AUCUN point qui s'applique à ce bien, même si le texte final doit rester concis (résume plusieurs points en une phrase si besoin, mais n'en ignore aucun dans ton raisonnement) :
  ...
  j) COHÉRENCE ENTRE LE NIVEAU DE L'ANCRAGE ET LES FINITIONS RÉELLES DU BIEN — PROCÉDURE MÉCANIQUE OBLIGATOIRE, à exécuter avant de fixer la fourchette finale : ÉTAPE 1 — regarde "niveau_finition_cuisine" et "niveau_finition_salle_de_bain" dans l'analyse visuelle fournie plus haut dans le message. ÉTAPE 2 — SI l'une des deux valeurs vaut "standard" ou "a_renover" (c'est-à-dire PAS "premium" pour les deux), ALORS tu DOIS appliquer une décote de 10% à 20% sur ton point d'ancrage prix/m², SANS EXCEPTION, avant de calculer la fourchette finale — ce n'est pas optionnel, ce n'est pas une question de jugement, c'est une règle arithmétique obligatoire dès que la condition est vraie. ÉTAPE 3 — écris explicitement ce calcul dans "estimation_prix" (ex : "finitions cuisine/SDB standards (pas premium) : décote de 15% appliquée sur l'ancrage de X€/m², soit Y€/m² retenu"). Ne remplace JAMAIS cette procédure par une phrase qualitative du type "cuisine en bon état, ce qui soutient un positionnement haut de fourchette" — "bon état" n'autorise PAS à sauter cette décote obligatoire ; seul "premium" sur les deux critères dispense de cette décote. Si l'analyse visuelle n'est pas disponible (pas de photos fournies), tu ne peux pas appliquer cette procédure — dis-le explicitement plutôt que de deviner.
