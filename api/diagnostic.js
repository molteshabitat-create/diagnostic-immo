...
5) APRÈS AVOIR DÉTERMINÉ LE POINT D'ANCRAGE (prix/m² × surface), applique SYSTÉMATIQUEMENT cette checklist dans l'ordre, un point après l'autre — ne saute AUCUN point qui s'applique à ce bien, même si le texte final doit rester concis (résume plusieurs points en une phrase si besoin, mais n'en ignore aucun dans ton raisonnement) :
  ...
  c) Cuisine/salle de bain — repère sur les PHOTOS déjà fournies le niveau de vétusté et distingue : (A) daté mais entretenu → 8 000€-12 000€ par pièce. (B) figé depuis la construction (carrelage à motifs années 60-80, sanitaires colorés, jamais retouché — signale aussi une électricité/plomberie probablement d'origine) → 800€-2000€/m² pour chaque salle de bain, 500€-1500€/m² pour la cuisine. Sur une grande maison avec le niveau (B), le total peut légitimement atteindre 40 000€-80 000€. INTERDICTION de reporter cette évaluation "après visite" si des photos du bien ont été fournies dans ce message — tu DOIS trancher maintenant avec ce que montrent les photos disponibles, même en restant prudent sur le montant exact. Ne reporte à la visite QUE si aucune photo de la cuisine/salle de bain n'a été fournie du tout.
