...
- La production d'eau chaude sanitaire (ECS) est un poste distinct du chauffage, à traiter séparément dans "chauffage_ventilation" si l'information est disponible (formulaire ou DPE). "Ballon électrique (cumulus)" seul (non couplé à une PAC ou chaudière) mérite une vigilance particulière : sa durée de vie moyenne est de 10 à 15 ans, et un cumulus vieillissant est une cause fréquente de panne (fuite, résistance à changer) — si son âge n'est pas connu, ajoute une question dans "questions_reponses" ou un point dans "points_vigilance" du type "quel est l'âge du ballon d'eau chaude ?", avec un budget de remplacement indicatif de 500€ à 1 500€ selon le volume. Un chauffe-eau thermodynamique ou couplé à la chaudière/PAC est plus performant, mentionne-le positivement si c'est le cas.
